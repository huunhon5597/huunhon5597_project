...
def _load_default_config():
    ...
    For Streamlit Cloud: Configure in App Settings > Secrets
    """
    # Check if running locally - try to load from .env file if it exists
    try:
        from dotenv import load_dotenv
        load_dotenv()
    except ImportError:
        pass  # dotenv not installed, continue with os.environ
    ...
    return {
        ...
        # Default values for local development only - DO NOT commit to git!
